...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--threads", dest="threads", default="3", required=False, help="Parallel threads to send the data."
    )
    parser.add_argument(
        "-sp", "--scan-pattern", dest="scan_pattern", default="*.dcm", required=False, help="Scan pattern."
    )
    parser.add_argument(
        "-max", "--max-series", dest="max_series", default="0", required=False, help="Max series count"
    )
