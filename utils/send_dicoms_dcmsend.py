...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--server", dest="server", default=None, required=True, help="Server address"
    )
    parser.add_argument(
        "-p", "--port", dest="port", default="11112", required=False, help="DICOM port server"
    )
    parser.add_argument(
        "-d", "--dataset", dest="dataset", default=None, required=False, help="Dataset name"
    )
    parser.add_argument(
        "-t",
        "--threads",
