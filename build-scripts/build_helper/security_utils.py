...
class TrivyUtils:
    ...
    def create_vulnerability_report(self, image):
        ...
        if not compressed_vulnerability_report == {}:
            ...
            with open(
                os.path.join(BuildUtils.build_dir, "compressed_vulnerability_report.json"), "w"
            ) as f:
        ...
        for report in chart_report["Results"]:
            if report["MisconfSummary"]["Failures"] > 0:
                ...
                for misconfiguration in report["Misconfigurations"]:
                    ...
                    compressed_chart_report[report["Target"]]["Description"] = misconfiguration[
                        "Description"
                    ]
                    compressed_chart_report[report["Target"]]["Message"] = misconfiguration[
                        "Message"
                    ]
                    compressed_chart_report[report["Target"]]["Severity"] = misconfiguration[
                        "Severity"
                    ]
