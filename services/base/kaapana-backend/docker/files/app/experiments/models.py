...
class Identifier(Base):
    ...
    cohorts = relationship(
        "Cohort", secondary="cohort_identifier", back_populates="cohort_identifiers"
    )
...
class Cohort(Base):
    ...
    cohort_identifiers = relationship(
        "Identifier", secondary="cohort_identifier", back_populates="cohorts"
    )
