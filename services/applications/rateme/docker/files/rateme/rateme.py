            ...
            children=[
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            [
                                html.Img(src=path_logo, height="70px"),  # ToDo: x-ray size can vary
                            ],
            ...
            [
                dbc.Col(
                    [
                        dbc.InputGroup(
                            [
                                dbc.InputGroupText("/", className="bg-info text-white p-2"),
                                dbc.Input(
                                    id="data_path",
                                    type="text",
                                    pattern=None,
                ...
                dbc.Col(
                    [
                        dbc.Progress(id="progress_bar", value=0, label="0%", color="success", striped=False),
                        dbc.Row(
                            [
                                dcc.Graph(id="plot1", style={"width": "90%", "display": "None"}, responsive=True),
                                html.Div(
                                    [
                                        dcc.RangeSlider(
                                            id="intensity_slider",
                        ...
                        dbc.Row(
                            [
                                ...
                                dbc.Popover(
                                    [dbc.PopoverHeader("File path"), dbc.PopoverBody("")],
                ...
                dbc.Col(
                    [
                        dbc.InputGroupText("Check missing annotations", className="bg-info text-white p-2"),
                        dcc.Dropdown(
...
@app.callback(Output("dummy_update", "children"), Input("upload", "contents"), prevent_initial_call=True)
...
@app.callback(Output("download", "data"), Input("download_button", "n_clicks"), prevent_initial_call=True)
def download_data(_):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-p", "--port", type=int, help="Specify the port where the app should run (localhost:port), default is 8050"
    )
    parser.add_argument(
        "-host", "--host_name", type=str, help="Name of the host on which the app is run, by default it is localhost"
    )
