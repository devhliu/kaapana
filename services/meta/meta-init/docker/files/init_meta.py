    ...
    for dashboard in all_dashboards:
        ...
        try:
            ...
            response = requests.post(
                ...
                data='{"attributes":' + json.JSONEncoder().encode(dashboard_source) + "}",
                verify=False,
                headers=osd_xsrf,
            )
...
def create_index():
    ...
    index_body = {
        ...
        "mappings": {
            ...
            "dynamic_templates": [
                {"check_integer": {"match_pattern": "regex", "match": "^.*_integer.*$", "mapping": {"type": "long"}}},
                {"check_float": {"match_pattern": "regex", "match": "^.*_float.*$", "mapping": {"type": "float"}}},
                {
                    "check_datetime": {
                        "match_pattern": "regex",
                        "match": "^.*_datetime.*$",
                        "mapping": {"type": "date", "format": "yyyy-MM-dd HH:mm:ss.SSSSSS"},
                    }
                },
                {
                    "check_date": {
                ...
                {"check_object": {"match_pattern": "regex", "match": "^.*_object.*$", "mapping": {"type": "object"}}},
                {
                    "check_boolean": {
                        "match_pattern": "regex",
                        "match": "^.*_boolean.*$",
                ...
                {"check_array": {"match_pattern": "regex", "match": "^.*_array.*$", "mapping": {"type": "array"}}},
            ],
        },
    }
    print("#")
