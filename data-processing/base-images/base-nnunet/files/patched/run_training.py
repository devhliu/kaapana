...
def main():
    ...
    parser.add_argument(
        "-val", "--validation_only", help="use this if you want to only run the validation", action="store_true"
    )
    parser.add_argument(
        "-c", "--continue_training", help="use this if you want to continue a training", action="store_true"
    )
    parser.add_argument(
        "-p",
    ...
    parser.add_argument(
        "--find_lr", required=False, default=False, action="store_true", help="not used here, just for fun"
    )
    parser.add_argument(
        "--valbest",
        required=False,
    ...
    parser.add_argument(
        "--disable_next_stage_pred", action="store_true", default=False, help="do not predict next stage"
    )
    parser.add_argument(
        "-pretrained_weights",
        type=str,
