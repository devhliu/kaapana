...
def predict_cases(
    ...
    preprocessing = preprocess_multithreaded(
        trainer, list_of_lists, cleaned_output_files, num_threads_preprocessing, segs_from_prev_stage
    )
    ...
    for preprocessed in preprocessing:
        ...
        results.append(
            pool.starmap_async(
                ...
                ((seg, output_filename, dct, interpolation_order, force_separate_z, interpolation_order_z),),
            )
        )
        print("done")
