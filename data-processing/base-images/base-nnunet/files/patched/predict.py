...
def predict_cases(
    ...
    interpolation_order_env = (
        int(interpolation_order_env) if interpolation_order_env.lower() != "default" else None
    )
...
def predict_cases_fastest(
    ...
    for preprocessed in preprocessing:
        ...
        print("initializing segmentation export")
        results.append(
            pool.starmap_async(save_segmentation_nifti, ((seg, output_filename, dct, 0, None),))
        )
        print("done")
