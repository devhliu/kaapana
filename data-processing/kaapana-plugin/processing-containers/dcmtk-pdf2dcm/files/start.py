...
def process_file(input_file, output_dir, input_dir=None, timeout=20):
    ...
    if dicom_input_dir is not None:
        ...
        try:
            ...
            study_description = (
                dcm_study_description if study_description is None else study_description
            )
...
for batch_element_dir in batch_folders:
    ...
    for file_found in files_grabbed:
        ...
        print("#")
        process_file(
            input_file=file_found, output_dir=element_output_dir, input_dir=element_input_dir
        )
