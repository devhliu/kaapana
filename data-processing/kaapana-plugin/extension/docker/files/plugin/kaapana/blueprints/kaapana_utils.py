...
def get_release_name(kwargs):
    ...
    release_name = cure_invalid_name(
        run_id, r"[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*", max_length=42
    ...
    if "ui_forms" in dag_dict and dag_dict["ui_forms"] is not None:
            ...
            dag_dict["ui_forms"].update(
                {
                    "data_form": {
                        "type": "object",
                        "properties": {"cohort_name": "$default", "cohort_limit": "$default"},
                    }
                }
            )
        ...
        for ui_form_key, ui_form in dag_dict["ui_forms"].items():
            if ui_form_key == "publication_form":
                ...
                default_properties = {
                    "cohort_name": {"type": "string", "title": "Cohort name", "oneOf": [], "required": True},
                    "cohort_limit": {
                        "type": "integer",
                ...
                default_properties = {
                    ...
                    "federated_round": {"type": "integer", "title": "Federated round", "readOnly": True},
                    "federated_total_rounds": {"type": "integer", "title": "Federated total rounds"},
                }
