...
class HelperMinio:
    ...
    def apply_action_to_object_names(
        minioClient, action, bucket_name, local_root_dir, object_names=None, file_white_tuples=None
    ):
        for object_name in object_names:
            ...
            if action != "put" or os.path.isfile(file_path):
                HelperMinio.apply_action_to_file(
                    minioClient, action, bucket_name, object_name, file_path, file_white_tuples
                )

    @staticmethod
    def apply_action_to_object_dirs(
        minioClient, action, bucket_name, local_root_dir, object_dirs=None, file_white_tuples=None, split_level=None
    ):
