...
class KaapanaBaseOperator(BaseOperator, SkipMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.volume_mounts.append(
            VolumeMount("mounted-scripts", mount_path="/app/mounted_scripts", sub_path=None, read_only=False)
        )
    ...
    def execute(self, context):
        ...
        self.env_vars.update({"RUN_ID": context["dag_run"].run_id, "DAG_ID": context["dag_run"].dag_id})
