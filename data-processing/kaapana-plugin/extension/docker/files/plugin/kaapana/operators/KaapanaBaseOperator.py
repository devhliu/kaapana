...
class KaapanaBaseOperator(BaseOperator, SkipMixin):
        ...
        **kwargs,
        ...
        self.volumes.append(
            Volume(
                ...
                configs={
                    "PersistentVolumeClaim": {"claim_name": "ms-jobs-pv-claim", "read_only": False}
                },
            )
        )
        ...
        self.volumes.append(
            Volume(
                name="tensorboard",
                configs={
                    "PersistentVolumeClaim": {"claim_name": "tb-jobs-pv-claim", "read_only": False}
                },
            )
        )
    ...
    def clear(
        self, start_date=None, end_date=None, upstream=False, downstream=False, session=None
    ):
    ...
    def set_defaults(
        ...
        enable_job_scheduler = (
            True
            if Variable.get("enable_job_scheduler", default_var="True").lower() == "true"
            else False
        )
        if obj.pool == None:
