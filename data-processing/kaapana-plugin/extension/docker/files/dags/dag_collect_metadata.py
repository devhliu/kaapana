...
from kaapana.operators.LocalDcmAnonymizerOperator import \
...
dag = DAG(dag_id="collect-metadata", default_args=args, concurrency=50, max_active_runs=50, schedule_interval=None)
...
put_to_minio = LocalMinioOperator(
    dag=dag, action="put", action_operators=[concat_metadata], bucket_name="downloads", zip_files=True
)
