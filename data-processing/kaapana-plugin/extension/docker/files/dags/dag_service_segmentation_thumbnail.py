...
from kaapana.operators.GenerateThumbnailOperator import \
...
dag = DAG(dag_id="service-segmentation-thumbnail", default_args=args, schedule_interval=None, tags=["service"])
...
generate_segmentation_thumbnail = GenerateThumbnailOperator(
    dag=dag, name="generate-segmentation-thumbnail", input_operator=combine_masks, orig_image_operator=dcm2nifti_ct
)
