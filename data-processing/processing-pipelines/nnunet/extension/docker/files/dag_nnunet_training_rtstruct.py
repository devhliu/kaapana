...
dcmstruct2nifti = DcmStruct2Nifti(
    dag=dag, input_operator=get_input, dicom_operator=get_ref_ct_series_from_struct, delete_input_on_success=False
)
...
dcm2nifti_ct = DcmConverterOperator(
    dag=dag, input_operator=get_ref_ct_series_from_struct, output_format="nii.gz", delete_input_on_success=False
)
