...
dag = DAG(dag_id="nnunet-model-install", default_args=args, concurrency=1, max_active_runs=1, schedule_interval=None)
...
extract_model = GetTaskModelOperator(dag=dag, name="install-model-zip", input_operator=dcm2bin, mode="install_zip")
