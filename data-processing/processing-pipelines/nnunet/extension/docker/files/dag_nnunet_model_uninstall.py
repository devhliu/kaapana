...
dag = DAG(dag_id="nnunet-model-uninstall", default_args=args, concurrency=1, max_active_runs=1, schedule_interval=None)

delete_model = GetTaskModelOperator(dag=dag, name="uninstall-nnunet-task", mode="uninstall")
