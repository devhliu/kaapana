...
from kaapana.blueprints.kaapana_global_variables import WORKFLOW_DIR, EXTENSIONS_NAMESPACE
...
class LocalDoccanoUploadDatasetOperator(KaapanaPythonBaseOperator):
    ...
    def __init__(self, dag, name="doccano-upload", *args, **kwargs):
        super().__init__(
            dag=dag, name=name, python_callable=self.start, execution_timeout=timedelta(minutes=30), *args, **kwargs
        )
