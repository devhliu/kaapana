...
class LocalGetTotalSegmentatorModelsOperator(KaapanaPythonBaseOperator):
    ...
    def download_url_and_unpack(url, config_dir, task_id):
        ...
        try:
            ...
            if proxies is not None:
                proxies = {"http": proxies, "https": proxies, "no_proxy": ".svc,.svc.cluster,.svc.cluster.local"}
    ...
    def __init__(self, dag, **kwargs):
        super().__init__(dag=dag, name="get-total-segmentator-models", python_callable=self.start, **kwargs)
