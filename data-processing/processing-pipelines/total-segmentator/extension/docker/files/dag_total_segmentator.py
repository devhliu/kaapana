...
from kaapana.operators.LocalCombineMasksOperator import \
    LocalCombineMasksOperator
...
get_total_segmentator_model = LocalGetTotalSegmentatorModelsOperator(dag=dag)
...
total_segmentator = TotalSegmentatorOperator(dag=dag, input_operator=dcm2nifti)

combine_masks = LocalCombineMasksOperator(dag=dag, input_operator=total_segmentator)
...
put_to_minio = LocalMinioOperator(
    dag=dag, action="put", action_operators=[pyradiomics], file_white_tuples=(".json")
)
