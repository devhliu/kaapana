...
keywords_ct = [
    ...
    "WaterEquivalentDiameterCalculationMethodCodeSequence" "RevolutionTime" "SingleCollimationWidth",
...
json_file_path = os.path.join(
    batch_output_dir, "scan_parameters_{}.json".format(datetime.now().strftime("%Y-%m-%d %H:%M:%S.%f"))
)
