...
dag = DAG(dag_id="rateme", default_args=args, concurrency=10, max_active_runs=max_active_runs, schedule_interval=None)
...
put_to_minio = LocalMinioOperator(
    dag=dag, action="put", action_operators=[rateme], bucket_name="rateme", zip_files=True
)
