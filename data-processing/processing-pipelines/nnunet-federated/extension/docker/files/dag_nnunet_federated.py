...
dag = DAG(dag_id="nnunet-federated", default_args=args, concurrency=5, max_active_runs=1, schedule_interval=None)
...
put_to_minio = LocalMinioOperator(
    dag=dag, action="put", action_operators=[nnunet_federated], zip_files=True, file_white_tuples=(".zip")
)
