...
class nnUNetFederatedTraining(KaapanaFederatedTrainingBase):
                    ...
                    if idx == 0:
                        ...
                        if "intensityproperties" in concat_dataset_properties:
                            ...
                            for mod_id, _ in concat_dataset_properties[
                                ...
                                voxels_in_foreground[mod_id] = concat_dataset_properties[
                                    "intensityproperties"
                                ][mod_id]["v"]
                                local_intensityproperties[mod_id] = collections.OrderedDict()
                                local_intensityproperties[mod_id][
                                    "local_props"
                                ] = concat_dataset_properties["intensityproperties"][mod_id][
                                    "local_props"
                                ]
                                print(idx, mod_id)
    ...
    def on_wait_for_jobs_end(self, federated_round):
        if federated_round == -2:
            ...
            self.remote_conf_data["federated_form"]["skip_operators"] = self.remote_conf_data[
                "federated_form"
            ]["skip_operators"] + [
                "get-input-data",
                "get-ref-series-ct",
