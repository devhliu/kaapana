...
ui_forms = {"workflow_form": {"type": "object", "properties": {"single_execution": "$default"}}}
...
dag = DAG(dag_id="example-dcm-extract-multiple-study-ids", default_args=args, schedule_interval=None)
